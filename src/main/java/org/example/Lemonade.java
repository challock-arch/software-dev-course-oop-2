...
public class Lemonade {
    ...
    public static Lemonade mix (Lemonade lemonade1, Lemonade lemonade2) {
        int combinedLemons = lemonade1.lemons += lemonade2.lemons;
        int combinedSugar = lemonade1.sugar += lemonade2.sugar;
        int combinedIce = lemonade1.ice += lemonade2.ice;
        Lemonade lemonade = new Lemonade(combinedLemons,combinedSugar,combinedIce);
